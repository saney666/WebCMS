			...
			createDateTimePicker = function( input ) {
						...
						input
							...
							.on('blur.xdsoft', function() {
								if( options.allowBlank && !$.trim($(this).val()).length ) {
									...
									datetimepicker.data('xdsoft_datetime').currentTime.setHours(0);
									datetimepicker.data('xdsoft_datetime').currentTime.setMinutes(0);
								}
								else{
									datetimepicker.data('xdsoft_datetime').setCurrentTime($(this).val());
 								}
				...
				calendar
					.on('click.xdsoft','td',function() {
					    timerclick++;
					    if (options.Time59) {
					        _xdsoft_datetime.currentTime.setHours(23);
					        _xdsoft_datetime.currentTime.setMinutes(59);
					    } else {
					        _xdsoft_datetime.currentTime.setHours(0);
