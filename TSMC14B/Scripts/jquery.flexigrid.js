...
(function ($) {
    ...
    $.addFlex = function (t, p) {
        ...
        p = $.extend({ //apply default properties
            ...
            page: 1, //current page
            total: 1, //total pages
            rptext: '每頁筆數', //rp Title
            useRp: true, //use the results per page select box
            rp: 15, //results per page
            rpOptions: [10, 15, 20, 30, 50], //allowed per-page values
            title: false,
            idProperty: 'id',
            pagestat: '顯示 第 {from} 項 到 第 {to} 項，總共 {total} 項目',
            pagetext: '頁次',
            outof: '共',
            findtext: 'Find',
        ...
        if (p.usepager) {
            ...
            if (p.useRp) {
                ...
                $('.pDiv2', g.pDiv).prepend("<div class='pGroup'>"+p.rptext+"<select name='rp'>" + opt + "</select></div> <div class='btnseparator'></div>");
